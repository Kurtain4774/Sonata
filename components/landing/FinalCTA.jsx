...
export default function FinalCTA() {
  ...
  return (
    <motion.section
      className="relative bg-gradient-to-br from-[#0a0a0a] via-[#0d1a0f] to-[#0a0a0a] py-24 px-6 overflow-hidden"
    ...
    >
      ...
      <div className="relative max-w-3xl mx-auto text-center">
        ...
        >
          Connect Spotify, describe the moment, and save the mix you want to keep.
        </motion.p>
