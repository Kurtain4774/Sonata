...
## Key Components
- Global: Navbar, ProfileMenu, Providers, ToastContext, SettingsContext, ErrorBoundary, OnboardingTour, GlobalMiniPlayer, AudioPreview(Provider), WebPlaybackProvider, SonataLogo
- Prompt/Tracks: FineTuneControls, TrackCard, TrackList, PlaylistSaveButton, MergeModal, ShareToggle
